            ...
            orphanage.open_on_weekends ?
              (
                <View style={[styles.scheduleItem, styles.scheduleItemGreen]}>
                  ...
                  <Text style={[styles.scheduleText, styles.scheduleTextGreen]}>Atendemos nos fins de semana.</Text>
                </View>
              ) :
              (
                <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
                  <Feather name="info" size={40} color="#FF669D" />
                  <Text style={[styles.scheduleText, styles.scheduleTextRed]}>Não atendemos nos fins de semana.</Text>
                </View>
              )
          }
        </View>
